...
fun ProductDetailsScreen(
    ...
    Scaffold(
        ...
        ProductDetailsBody(
            ...
            //onSellProduct = { viewModel },
            onDelete = {
                // Note: If the user rotates the screen very fast, the operation may get cancelled
                // and the product may not be deleted from the Database. This is because when config
...
fun ProductDetails(
    ...
    Card(
        ...
        Column(
            ...
            ProductDetailsRow(
                labelResID = R.string.category_type,
...
fun ProductDetailsScreenPreview() {
    InventoryTheme {
        ProductDetailsBody(ProductDetailsUiState(
            outOfStock = true, productDetails = ProductDetails(1, "Pen", "$1.00", "scholar util")
        ),
            //onSellProduct = {},
            onDelete = {})
    }
